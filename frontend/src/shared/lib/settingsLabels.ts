...
export const SETTINGS_META: Record<string, SettingMeta> = {
  ...
  'site.permitir_cadastro_publico': { label: 'Permitir cadastro público', group: 'Acesso',   inputType: 'boolean'  },
  'documentos.itens_por_pagina':    { label: 'Itens por página',        group: 'Documentos', inputType: 'number'   },
  'documentos.permitir_download':   { label: 'Permitir download',       group: 'Documentos', inputType: 'boolean'  },
};
